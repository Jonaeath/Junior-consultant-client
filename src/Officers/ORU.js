    ...
    return (
       <div>
        ...
        <div className="w-full p-6 m-auto bg-white rounded-md shadow-md lg:max-w-xl">
            <h1 className="text-3xl font-semibold text-center text-purple-700">Officers Reported Upon(ORU)</h1>
            <form onSubmit={handelMyfrom} className="space-y-4">
                <div>
